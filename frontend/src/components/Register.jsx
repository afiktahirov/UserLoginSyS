    ...
    <div className='container mx-auto'>
        <div className='-mx-4 flex flex-wrap'>
            <div className='w-full px-4'>
                <div
                    className='relative mx-auto max-w-[525px]
           overflow-hidden rounded-lg bg-white py-16 px-10
           text-center sm:px-12 md:px-[60px]'>
                    <div className='mb-10 text-center md:mb-16'>Register Page</div>
             ...
             outline-none focus:border-primary focus-visible:shadow-none'
                        ...
                        <div className='mb-4'>
                            <input type="password" value={password_confirmation}
                                onChange={(e)=>setPasswordConfirmmation(e.target.value)} placeholder='Password Confirm'
                            className='bordder-[#E9EDF4]
                          w-full
                          rounded-md
                          border bg-[#FCFDFE]
                        ...
                        <div className='mb-10'>
                            <button type='submit'
                                className='w-full px-4 py-3 bg-indigo-500 
                          hover:bg-indigo-700
                          rounded-md
                          text-white'>
                                Register
                    ...
                    <p className='text-base text-[#adadad]'>
                        Not a member yet?
                        <Link to="/register" className='text-primary hover:underline'> Login</Link>
                    </p>
                </div>
            </div>
        </div>
